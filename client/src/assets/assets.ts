...
export const AiToolsData: TAiTools[] = [
  {
...
export const dummyTestimonialData: TDummyTestimonial[] = [
  {
...
type TDummyCreationData = {
  id: number;
  user_id: string;
  prompt: string;
  content: string;
  type: "image" | "blog-title" | "article";
  publish: boolean;
  likes: string[];
  created_at: string;
  updated_at: string;
};
export const dummyCreationData: TDummyCreationData[] = [
  {
    id: 9,
...
type TDummyPublishedCreationData = {
  id: number;
  user_id: string;
  prompt: string;
  content: string;
...
export const dummyPublishedCreationData: TDummyPublishedCreationData[] = [
  {
    id: 1,
    user_id: "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
    prompt:
